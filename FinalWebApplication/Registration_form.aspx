...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="container">
        ...
        <form method="post" runat="server" onsubmit="return checkForm();">
            ...
            <label for="birthYear" class="required-label">Year of Birth:</label>
            ...
            <div class="phone-prefix-container">
                <label for="phonePrefix" class="phone-prefix-label" "required-label">Phone Prefix:</label>
            ...
            <label class="required-label">Having Domestic Pets:</label>
